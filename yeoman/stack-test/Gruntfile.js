module.exports = function( grunt ) {
  ...
  // Alias the `server` task to run our express app instead
  grunt.registerTask('server', 'run the new dmb server', function() {
    var done = this.async();
    require('child_process').exec('nodemon ./app/app.js', function(err, stdout) {
      grunt.log.write(stdout);
      done(err);
    });
  });
