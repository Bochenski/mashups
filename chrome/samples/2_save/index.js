...
var saveIntent = function() {
  ...
  var saveService = "chrome-extension://kilpmfbhbfjpefbpdfembjladlhkglbj/save.html";
  // NOTE: can use a chrome extension API to get the url for our own service:
  saveService = chrome.extension.getURL("save.html");

  // Alternatively, you can delegate to the PicStore save intent...
  var saveServicePicStore = "chrome-extension://pikngaodhhgggboipbmmckapiooilgof/save.html";
  ...
  // Also, try removing the "service" explicit marker, and then pick it at
  // runtime.
};
